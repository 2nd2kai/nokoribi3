...
const CONVS=[
  ...
  {meaning:"宛名のない封筒を消さずに預かる理由を確かめる場面。",id:"ku10",a:"kana",b:"utsuro",th:10,title:"宛名がなくても",lines:[["k","封筒、増えてるね。"],["u","ある。全部、ある。"],["k","それ、重くない？"],["u","重いかもしれない。でも、預かった。"],["k","宛名がなくても？"],["u","宛名がなくても、捨てない。"]],fx:{type:"stability",who:"utsuro",v:3}},
  {meaning:"まだ読めない封筒を保管を選ぶ場面。",id:"uc10",a:"utsuro",b:"kotae",th:10,title:"まだ読まない",lines:[["o","この封筒、読めそう？"],["u","まだ。"],["o","開けてもいないのに？"],["u","熱い。"],["o","……そっか。"],["u","今読んだら、答えじゃなくて傷になる。"],["o","じゃあ、保管で。"],["u","うん。消さない。"]],fx:{type:"analysis",v:3}},
  {meaning:"受領証の下書きを審査官が保留にする場面。",id:"koa10",a:"kotae",b:"auditor",th:10,title:"保留",lines:[["o","受領証の下書きができました。"],["a","……保留だ。"],["o","理由をください。"],["a","まだ、自分を刺す形をしている。"],["o","判決ですか。"],["a","検品だ。"],["o","では、捨てません。"],["a","捨てるな。直せ。"]],fx:{type:"pressure",v:-3}},
  {meaning:"みんなを怖がらせていた審査官の本音が出る場面。",id:"ka8",a:"kana",b:"auditor",th:8,title:"責めてるんですか",lines:[["k","あなたは、責めてるんですか。"],["a","……。"],["k","みんな、あなたを怖がってます。"],["a","怖がれば止まる。"],["k","止まれば、守れる？"],["a","壊れるよりはいい。"],["k","でも、止まり続けても壊れます。"],["a","……知っている。"]],fx:{type:"pressure",v:-5}},
];
    ...
    <div className="ov battle-ov" onClick={p.onClose}>
      <div className="battle-modal" onClick={function(e){e.stopPropagation();}}>
        ...
        <div className="battle-self-answer-box">
          ...
          <textarea className="bsa-input" rows={2} placeholder="例：「それは本当かもしれない。でも今日は保留する」" value={selfAnswer} onChange={function(e){setSelfAnswer(e.target.value);}}/>
          {selfAnswer.trim()&&<div className="bsa-bonus">回収率 +3〜5% ボーナス / 残り火データに記録されます</div>}
        </div>
...
function GoalsPanel(p){
  ...
  return <div className="goals-panel"><div className="lh">今日の目標</div>{goals.map(function(g){return <QuestCard key={g.id} goal={enrichGoal(g,game)} onNav={onNav} onQuick={onQuick}/>;})}</div>;
}
...
function ReceiptReceiveModal(p){
  ...
  return <div className="ov" onClick={p.onClose}><div className="bsh receive-bsh" onClick={function(e){e.stopPropagation();}}>
    <div className="sh-handle"/>
    <p className="sh-title">受け取る前の確認</p>
